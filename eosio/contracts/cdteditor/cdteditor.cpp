...
CONTRACT cdteditor : public eosio::contract {
	public:
...
typedef eosio::multi_index< "testtab"_n,  cdteditor::testtable > testtable_t;
typedef eosio::multi_index< "testtaba"_n, cdteditor::testtable > testtable_a_t;
typedef eosio::multi_index< "testtab2"_n, cdteditor::test_table2 > testtable2_t;
